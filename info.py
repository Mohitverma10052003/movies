...
# Bot information
SESSION = environ.get('SESSION', 'ItzVerma')
API_ID = int(environ.get('API_ID', '27547358'))
API_HASH = environ.get('API_HASH', '675a9c08fc93de993ae6aff91d25bf29')
BOT_TOKEN = environ.get('BOT_TOKEN', "7293392487:AAEa-V68FNOcErx_edHquLEuT6DHhK-laS8")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/0622181f027555f4612c0-a53af27c680d497eb5.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2044702863').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002270591284'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002461283565').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mohit1:mohit1@mohit1.vfcx0.mongodb.net/?retryWrites=true&w=majority&appName=mohit1")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "mohit1")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'itsvermacollection')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/c90cd3dc7f0c26a6c64f6-4f2d5debe7207bdf0c.jpg') # payment code picture url.
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs - \n\n- 30ʀs - 1 MONTH\n- 50ʀs - 2 ᴍᴏɴᴛʜs\n- 80ʀs - 3 ᴍᴏɴᴛʜs\n- 150ʀs - 6 ᴍᴏɴᴛʜs\n\n🎁 ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs 🎁\n\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴠᴇʀɪғʏ\n○ ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴏᴘᴇɴ ʟɪɴᴋ\n○ ᴅɪʀᴇᴄᴛ ғɪʟᴇs\n○ ᴀᴅ-ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ\n○ ʜɪɢʜ-sᴘᴇᴇᴅ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ\n○ ᴍᴜʟᴛɪ-ᴘʟᴀʏᴇʀ sᴛʀᴇᴀᴍɪɴɢ ʟɪɴᴋs\n○ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏᴠɪᴇs & sᴇʀɪᴇs\n○ ꜰᴜʟʟ ᴀᴅᴍɪɴ sᴜᴘᴘᴏʀᴛ\n○ ʀᴇǫᴜᴇsᴛ ᴡɪʟʟ ʙᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ɪɴ 1ʜ ɪꜰ ᴀᴠᴀɪʟᴀʙʟᴇ\n\n✨ ᴜᴘɪ ɪᴅ - <code>mrverma73575-3@oksbi</code>\n\nᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan\n\n💢 ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ\n\n‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ</b>')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+OHjrcgklmlBjZTM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+OHjrcgklmlBjZTM1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Itzofficialverma') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'c1a8aba9e132916bf5ea0574aecb27ab34b50bc1')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/How_to_openlink012/2')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hello Bhailogo Kya Hal Hai 🫡')
CUSTOM_FILE_CAPTION = environ.get("", f"{script.CAPTION}")
